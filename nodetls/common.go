...
func standardTlsConfig(ctx context.Context, tlsCerts []tls.Certificate, pool *x509.CertPool, opt ...nodee.Option) (*tls.Config, error) {
	const op = "nodee.nodetls.standardTlsConfig"
	...
	if opts.WithSkipVerifyConnection {
