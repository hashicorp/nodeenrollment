...
func (c *multihopServiceClient) FetchNodeCredentials(ctx context.Context, in *types.FetchNodeCredentialsRequest, opts ...grpc.CallOption) (*types.FetchNodeCredentialsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MultihopService_FetchNodeCredentials_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multihopServiceClient) GenerateServerCertificates(ctx context.Context, in *types.GenerateServerCertificatesRequest, opts ...grpc.CallOption) (*types.GenerateServerCertificatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MultihopService_GenerateServerCertificates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *multihopServiceClient) RotateNodeCredentials(ctx context.Context, in *types.RotateNodeCredentialsRequest, opts ...grpc.CallOption) (*types.RotateNodeCredentialsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MultihopService_RotateNodeCredentials_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMultihopServiceServer must be embedded to have
...
func (UnimplementedMultihopServiceServer) FetchNodeCredentials(context.Context, *types.FetchNodeCredentialsRequest) (*types.FetchNodeCredentialsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchNodeCredentials not implemented")
}
...
func (UnimplementedMultihopServiceServer) RotateNodeCredentials(context.Context, *types.RotateNodeCredentialsRequest) (*types.RotateNodeCredentialsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RotateNodeCredentials not implemented")
}
func (UnimplementedMultihopServiceServer) mustEmbedUnimplementedMultihopServiceServer() {}
func (UnimplementedMultihopServiceServer) testEmbeddedByValue()                         {}
...
func RegisterMultihopServiceServer(s grpc.ServiceRegistrar, srv MultihopServiceServer) {
	// If the following call panics, it indicates UnimplementedMultihopServiceServer was
