...
// NewFileStorage creates a new object that implements the Storage interface in
...
func NewFileStorage(ctx context.Context, opt ...Option) (*FileStorage, error) {
...
func (ts *FileStorage) Store(ctx context.Context, msg nodeenrollment.MessageWithId) error {
	...
	if err := types.ValidateMsg(msg); err != nil {
